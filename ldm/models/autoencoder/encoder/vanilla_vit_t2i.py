...
class FinalLayer(nn.Module):
    ...
    def __init__(self, latent_dim, embed_dim, moments_factor=1):
        ...
        self.mlp = nn.Sequential(nn.Linear(embed_dim, out_features))
...
class VanillaViTEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        self.pos_embed = nn.Parameter(
            torch.randn(1, self.num_patches + self.extras, embed_dim)
            if pos_embed_learned
            else torch.zeros(1, self.num_patches + self.extras, embed_dim),
