...
<p align="center">
  <img src="assets/readme/pair_01.gif" alt="Interpolation 1" width="22%" style="margin:10px; background-color:#f0f0f0; border-radius:10px; padding:5px;">
...
=======
  ...
  <img src="assets/readme/pair_18.gif" alt="Interpolation 8" width="22%" style="margin:10px; background-color:#f0f0f0; border-radius:10px; padding:5px;">
>>>>>>> 00d6e81 (src: Update instructionts)
</p>
