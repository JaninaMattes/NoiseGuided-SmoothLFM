...
def test_smoothness_metrics():
    ...
    print(
        f"Smooth interpolation results: PPL={smooth_results['ppl']:.4f}, ISTD={smooth_results['istd']:.4f}"
    )
    ...
    print(
        f"Jagged interpolation results: PPL={jagged_results['ppl']:.4f}, ISTD={jagged_results['istd']:.4f}"
    )
